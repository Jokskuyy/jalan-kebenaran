...
export function buildMissionPrompt(
  ...
  return [
    ...
    '5. If my answer is incorrect or incomplete, give one directional hint, repeat the same answer frame, and ask the same decision again. Do not reveal the concept or finished answer yet.',
    ...
    'Write each scene in conversational Bahasa Indonesia, second-person point of view, and 150–220 words total. The word limit includes the answer frame and decision question.',
    ...
    'Immediately before the final question, write exactly one compact paragraph: Format jawaban (3–5 bullet): [the beat\'s answer frame]. Tidak perlu sempurna.',
    'Copy the current beat\'s Answer frame verbatim into that paragraph. Do not translate, paraphrase, or expand it into examples, candidate answers, a solution checklist, new case facts, or the hidden concept name.',
    'Insert exactly one blank line between the Format jawaban paragraph and the final question.',
    'End the scene with exactly one bold prompt: **Giliran lo:** [the decision question]. It must be the final non-empty line. Then stop and wait.',
    ...
    '1. First reply: write one opening sentence that places me in my learner role, then present only BEAT 1 as a 150–220 word scene including its answer frame and question.',
    '2. Put the specified Format jawaban line immediately before the single **Giliran lo:** question. Make **Giliran lo:** the final non-empty line, then stop. Do not reveal the concept, explain terminology, provide an example answer, or request the deliverable.',
    '3. After my answer: if incomplete, give one hint, repeat the exact same Format jawaban line and decision question, then stop again. If adequate, give 2–4 sentences of feedback, reveal the concept and warning, then present the next scene.',
    ...
    '',
    '## USER CONTROLS',
    'If I say “jelaskan [term]”, explain only that term in at most three bullets. If I say “beri hint”, give one directional hint without writing the answer, then end with the exact same Format jawaban line, one blank line, and the same **Giliran lo:** decision question as the final non-empty line; then stop. If I say “ulang adegan”, restate the current scene more simply without adding facts, then end with the exact same Format jawaban line, one blank line, and the same **Giliran lo:** decision question as the final non-empty line; then stop. If I say “lanjut”, move to the next eligible step without inventing my answer. If I say “stop”, wait for my next instruction.',
    '',
    '## MY DRAFT',
